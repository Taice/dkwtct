...
pub fn resizeFont(gpa: Allocator, f: *rl.Font, new_size: i32) !void {
...
pub fn addCodepointsToFont(f: *rl.Font, cps: []i32, gpa: Allocator) !void {
    ...
    rl.unloadFont(f.*);
    f.* = try rl.loadFontFromMemory(".ttf", v.char_font_data, v.fs, codepoints);
}
...
pub fn addLayoutToFont(gpa: Allocator, layout: *const Layout, f: *rl.Font) !void {
